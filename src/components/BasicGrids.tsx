...
const BasicCell = ({ col, row, baseTime, curr }: BasicCellProps) => {
  ...
  return (
    <div
      className={cn('border-border box-border border', past ? 'bg-gray-200/70' : 'transition-all duration-300 ease-out relative overflow-hidden bg-gradient-to-br hover:from-blue-100/80 hover:to-indigo-100/60 hover:border-blue-300/60 hover:scale-[1.02] hover:shadow-md cursor-pointer')}
